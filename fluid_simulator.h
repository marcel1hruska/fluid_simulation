...
namespace simulation
{
	...
	private:
		...
		//buffer IDs
		GLuint terrain_shader_id_, water_shader_id_, mesh_element_id_, water_vertex_id_, terrain_vertex_id_, color_id_, array_id_, heights_id_;
